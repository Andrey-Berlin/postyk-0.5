...
header.innerHTML = `<h1>Postyk с редактором и кодировкой текста и с возможностью сохранить файл .txt или открыть файл .txt</h1>
...
<textarea class="in" id="in"></textarea>
...
<main id="main" data-mode="inputBinary">
  ...
  <p id = 'code'><code id="output"><br></code></p>
  <hr />
  <!--p>Example</p>
  <div id="example-box">
...
<hr>
<br>
<input type="range" min="18" name="a" max="100" value="18" step="2" id="font size" >
...
seeText.style.border = 'thick double #031b25be';
...
var exampleBinary = "01010100 01101000 01101001 01110011 00100000 01101001 01110011 00100000 01101101 01111001 00100000 01100110 01101001 01110010 01110011 01110100 00100000 01100010 01101001 01101110 01100001 01110010 01111001 00100000 01110011 01100101 01101110 01110100 01100101 01101110 01100011 01100101 00101110";
var exampleText = "This is my first binary sentence.";*/
...
input.addEventListener("input", function() {
  ...
  if (main.dataset.mode == "inputBinary") {
    output.innerHTML = binaryAgent(userInput.toString()) + '<br>';
  } else {
    output.innerHTML = textAgent(userInput.toString())+ '<br>';
  }
});
